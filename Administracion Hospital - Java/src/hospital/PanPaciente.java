 ...
 * @author Jhandry
 */
public class PanPaciente extends javax.swing.JFrame {

    /**
     * Creates new form PanPaciente
     */
    public PanPaciente() {
        initComponents();
        setLocationRelativeTo(getParent());
        crudSqlPaciente crudPaciente=new crudSqlPaciente();
        crudPaciente.mostrarTabla(tblPaciente);
    }
    ...
    private void initComponents() {
        ...
        tblPaciente.setBackground(new java.awt.Color(247, 247, 247));
        tblPaciente.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        jLabel2.setText("Buscar Hospital:");

        txtCedulaPaciente.setText("Ingrese Cedúla");
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addComponent(txtCedulaPaciente, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void tblPacienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPacienteMouseClicked
        crudSqlPaciente crudobjPaciente = new crudSqlPaciente();
        crudobjPaciente.SeleccionarPaciente(tblPaciente, txtCedulaPaciente);
    ...
    private void btnHospitalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHospitalActionPerformed
        AsignarHospitalPaciente asignarHospitalPaciente = new AsignarHospitalPaciente();
        asignarHospitalPaciente.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PanPaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PanPaciente().setVisible(true);
            }
        });
    }
